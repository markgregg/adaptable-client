...
class ResponseRuleImplTest : FunSpec({
    ...
    test("When true returns response") {
        ...
        (responseRule.process(WebRequest("test"), true)?.toDom() as io.github.markgregg.common.web.TextResponse)
            .body shouldBe "test"
    }
    ...
    test("When not true runs alternate rule") {
        ...
        (responseRule.process(WebRequest("test2"), true)?.toDom() as io.github.markgregg.common.web.TextResponse)
            .body shouldBe "test2"
    }
