...
import io.github.markgregg.client.api.exceptions.*
...
import io.github.markgregg.client.socket.WebSocketClientFactoryImpl
...
class Test internal constructor(
    ...
    private val endPoints = HashMap<String, io.github.markgregg.client.api.EndPoint>()
